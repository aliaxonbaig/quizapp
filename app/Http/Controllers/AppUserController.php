...
class AppUserController extends Controller
{
    ...
    public function deleteUserQuiz($id)
    {
        ...
        if (auth()->id() == $quizheader->user_id) {
            $quizheader->delete();
            return redirect()->back()->withSuccess("Quiz deleted successfully!");
        }
    ...
    public function userQuizDetails($id)
    {
        ...
        $userQuizDetails = QuizHeader::where('id', $id)->with('section')->first();
        ...
        return view('appusers.userQuizDetail', compact('userQuizDetails', 'quizQuestionsList', 'userQuiz', 'quizQuestions', 'choice'));
    }
}
